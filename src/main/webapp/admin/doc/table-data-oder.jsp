                                ...
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            ArrayList<Bill> listBill = billDao.getAllBills();
                                        ...
                                        <tr>
                                            ...
                                            <td><%=formatter.format(Double.parseDouble(bill.getTotal()))%> đ</td>
                                            <td style="min-width: 60px; overflow-wrap: break-word"><%=bill.getPaymentMethod()%></td>
