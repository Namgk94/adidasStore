 ...
 * @author NAM
 */
@WebServlet(name = "AddProductServlet", urlPatterns = {"/admin/delete-product"})
public class DeleteProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = null;
        if(request.getParameter("idDeleted") != null){
           id = request.getParameter("idDeleted"); 
        }
        
        if (id != null) {
            Product product = ListProducts.searchProductById(id);
            if (product != null) {
