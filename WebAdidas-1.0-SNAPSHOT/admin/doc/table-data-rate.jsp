...
<html lang="en">
    ...
    <head>
        <title>Đánh giá sản phẩm | Quản trị Admin</title>
        <meta charset="utf-8">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item active" href="table-data-rate.jsp"><i class='app-menu__icon bx bx-run'></i><span
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                ...
                                <tbody>
                                    <%
                                        ArrayList<BillDetail> bills = RateDao.getAllReviews();
                                        if (bills != null || bills.size() > 0) {
                                            for (BillDetail bill : bills) {%>
                                    <tr>
                                        <td><%=bill.getProduct().getProductID()%></td>
                                        <td><%=bill.getBillId()%></td>
                                        <td>
                                            <p><%=bill.getProduct().getProductName()%></p>
                                            <p>Size: <%=bill.getSize()%></p>
                                        </td>
                                        <td><%=bill.getUserName()%></td>
                                        <td><%=bill.getRateStar()%></td>
                                        <td><%=bill.getReviewHeader()%></td>
                                        <td><%=bill.getReviewText()%></td>
                                        <td><%=bill.getRateTime()%></td>
                                        <!--         <td><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"><i class="fas fa-trash-alt"></i></button>-->
                                        <!--<button class="btn btn-primary btn-sm edit" type="button" title="Phản hồi"><i class="fa fa-edit"></i></button></td>-->
                                    </tr>
                                    <% }
                                        }%>
                                </tbody>
